...
def define_api_routes():
    ...
    # Setup API routes
    api.add_resource(Customers,   '/customers', endpoint='customer_put', methods=['PUT'])
    api.add_resource(Customers,   '/customers/<string:email_address>', endpoint="customers", methods=['GET'])
